...
resource "aws_instance" "my_instance" {
  ...
  user_data                   = <<-EOF
              ...
              git clone -b main https://github.com/pwr-cloudprogramming/a10-palishiita.git

              echo "Building Maven project"
              cd a10-palishiita/backend
              mvn package
              cd ../..
              ...
              JS_FILE="a10-palishiita/frontend/src/play.js"  # Update with the path to your JavaScript file
              ...
              CONFIG_FILE="a10-palishiita/frontend/src/config.json"
